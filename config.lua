...
QBConfig.Money.PayCheckSociety = false -- If true paycheck will come from the society account that the player is employed at, requires btd-bossmenu
...
QBConfig.Player.AddictionRate = 2.2 -- Rate at which addiction goes down.
...
QBConfig.Server.ClosedReason = "Server Down at this Time" -- Reason message to display when people can't join the server
...
QBConfig.Server.Discord = "discord.gg/Bastrado" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = {'god', 'admin', 'mod' , 'vip'} -- Add as many groups as you want here after creating them in your server.cfg
